...
public class Constants {
	...
	public static final Pattern PEOPLE_PATTERN = Pattern.compile("<PEOPLE><D>(.*)<\\/D><\\/PEOPLE>");
	public static final Pattern ORGS_PATTERN = Pattern.compile("<ORGS><D>(.*)<\\/D><\\/ORGS>");
	public static final Pattern EXCHANGES_PATTERN = Pattern.compile("<EXCHANGES><D>(.*)<\\/D><\\/EXCHANGES>");
